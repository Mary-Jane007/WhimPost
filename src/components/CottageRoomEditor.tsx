...
export function CottageRoomEditor({
  profile,
  village,
  ...
  /** When true, hide duplicate page chrome (nameplate / stats) for embedding. */
  embedded?: boolean;
}) {
  ...
  return (
    ...
    >
      {!embedded ? (
        ...
        <p className="cottage-saving vh-embedded-saving">Saving…</p>
      ) : null}
